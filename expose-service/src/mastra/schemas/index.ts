...
export const prepareExposeDataOutputSchema = z.object({
  property: propertyExposeDataSchema,
  ready: z.boolean(),
});
export const generateExposeContentOutputSchema = z.object({
  property: propertyExposeDataSchema,
  content: exposeContentSchema,
});

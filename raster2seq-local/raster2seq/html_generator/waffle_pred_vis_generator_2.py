...
path_B = "pred_outputs/waffle_raster00000_clean_preds/checkpoints/"
...
cols = [
    ...
    Col('img', 'Raster2Seq', results_B), # specify image content for column 4
    Col('img', 'Raster2Seq Map', results_B2),     # specify image content for column 3
]

# html table generation
imagetable(cols, out_file='waffle_pred_vis_ours.html', imsize=(1024, 1024))

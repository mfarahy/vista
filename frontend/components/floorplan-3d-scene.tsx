 ...
 * dollhouse-style structure: room floors, walls, doors, windows, and room
 * name labels, with orbit controls so the user can rotate and inspect the
 * model. Pure presentation — it never mutates data and only knows the
 * standardized FloorPlan3DModel shape.
 */
...
function addRoom(
  ...
  floor.position.set(room.x, 0.06, room.y);
  group.add(floor);
